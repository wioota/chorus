class RenameGpdbInstanceToGpdbDataSource < ActiveRecord::Migration
  def up
    ...
    execute "UPDATE events SET target1_type = 'GpdbDataSource' WHERE target1_type = 'GpdbInstance'"
    execute "UPDATE events SET target2_type = 'GpdbDataSource' WHERE target2_type = 'GpdbInstance'"
  ...
  def down
    ...
    execute "UPDATE events SET target1_type = 'GpdbInstance' WHERE target1_type = 'GpdbDataSource'"
    execute "UPDATE events SET target2_type = 'GpdbInstance' WHERE target2_type = 'GpdbDataSource'"
