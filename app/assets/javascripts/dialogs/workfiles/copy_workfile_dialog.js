    ...
    submit: function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                // File Name = copiedWorkfile.get("fileName")
                var copiedFileUrl = copiedWorkfile.showUrl();
                var copiedFileLink_html = "<a href='" + copiedFileUrl + "'>" + copiedWorkfile.get("fileName") + "</a>";

                chorus.toast("workfile.copy_dialog.toast", {workfileURL: copiedFileLink_html, workspaceNameTarget: self.selectedItem().get("name")});
            },
