module PackageMaker
  ...
  def make_installer
    ...
    system("GZIP='--fast' #{rails_root}/packaging/makeself/makeself.sh --follow --nox11 --nowait #{install_root} chorus-#{version_name}.sh 'Chorus #{Chorus::VERSION::STRING} installer' #{labeler} ./chorus_installation/packaging/setup/chorus_installer") || exit(1)
  end
