unless Rails.env.production?
  namespace :jasmine do
    ...
    puts "*** fixtures.rake: BEGIN fixtures: Regenerate JSON fixtures for jasmine tests"
...
puts "*** fixtures.rake: END fixtures: Regenerate JSON fixtures for jasmine tests"
