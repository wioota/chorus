...
group :test, :integration, :packaging, :"test-jasmine", :"test-legacy-migration" do
  gem 'rr'
  gem 'fuubar'
  gem 'factory_girl'
...
group :test, :development, :integration, :packaging, :"test-jasmine", :"test-legacy-migration" do
