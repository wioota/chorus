...
group :test, :integration, :packaging, :ci_jasmine, :ci_legacy_migration, :ci_legacy do
...
group :test, :development, :integration, :packaging, :ci_jasmine, :ci_legacy_migration, :ci_legacy do
