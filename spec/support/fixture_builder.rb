...
FixtureBuilder.configure do |fbuilder|
  ...
  fbuilder.factory do
    ...
    hdfs_data_source = HdfsDataSource.create!({:name => 'searchquery_hadoop', :description => 'searchquery for the hadoop data source', :host => 'hadoop.example.com', :port => '1111', :owner => admin, :hdfs_version => 'Pivotal HD 2.0'}, :without_protection => true)
