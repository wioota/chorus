...
FixtureBuilder.configure do |fbuilder|
  ...
  fbuilder.factory do
    ...
    # Search Chorus Views
    search_chorus_view_1 = FactoryGirl.create(:chorus_view, :name => "searchquery_chorus_view_1", :schema => searchquery_schema, :query => "select searchquery from a_table", :workspace => search_public_workspace)
