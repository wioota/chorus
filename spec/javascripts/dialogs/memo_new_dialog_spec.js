...
//         });
        ...
        it("makes a cl editor with toolbar", function() {
            ...
            expect(this.dialog.makeEditor).toHaveBeenCalledWith($(this.dialog.el), "body", { width : 'auto', height: 200, controls : "bold italic | bullets numbering | link unlink | removeformat" } );
