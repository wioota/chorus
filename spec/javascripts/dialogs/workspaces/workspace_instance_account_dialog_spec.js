describe("chorus.dialogs.WorkspaceInstanceAccount", function() {
    ...
    describe("#render", function() {
        ...
        it("has the right body text", function() {
            expect(this.dialog.$('.dialog_content')).toContainTranslation("workspace.instance.account.body", {dataSourceName: this.workspace.sandbox().database().dataSource().get("name")});
        });
    });
});
