describe("chorus.dialogs.EditWorkspace", function() {
    ...
    describe("#render", function() {
        ...
        it("makes a cl editor with toolbar", function() {
            ...
            expect(this.dialog.makeEditor).toHaveBeenCalledWith($(this.dialog.el), "summary", { width : 'auto', height : 200, controls : "bold italic | bullets numbering | link unlink | removeformat" });
        });
