            ...
            context("with valid values", function() {
                ...
                context("when the post to import responds with success", function() {
                    ...
                    it("closes the dialog and displays the right toast", function() {
                        ...
                        expect(chorus.toast).toHaveBeenCalledWith("hdfs.create_external.success.message", {workspaceName: this.workspace3.get("name"), tableName: this.dialog.$("input:text").eq(0).val()});
                    });
