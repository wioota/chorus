describe("chorus.views.DataSourceItem", function() {
    ...
    describe("when the model is a data source", function() {
        ...
        it("displays the state icon", function() {
            ...
            expect(this.view.$("img.state").attr("title")).toContainTranslation("instances.state.online");
            this.model.set("online", false);
            this.view.render();
            expect(this.view.$("img.state").attr("src")).toBe("/images/data_sources/yellow.png");
            expect(this.view.$("img.state").attr("title")).toContainTranslation("instances.state.offline");
        });
