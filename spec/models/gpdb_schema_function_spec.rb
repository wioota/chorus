...
describe GpdbSchemaFunction do
  context "#initialize" do
    it "initializes the value" do
      schema_function = GpdbSchemaFunction.new("a_schema", "foo", "sql", "text", [], %w{text}, "add 1 + 2", "its 5:43")
    ...
    it "makes an array out of the curly-braced string" do
      schema_function = GpdbSchemaFunction.new("a_schema", "foo", "sql", "text", %w{height width depth}, ["int4", "int5" ,"int6"],"add 1 + 2", "its 5:43")
