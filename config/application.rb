...
if defined?(Bundler)
  ...
  Bundler.require(*Rails.groups(:assets => %w(development test integration ci_jasmine)))
...
module Chorus
  class Application < Rails::Application
    ...
    config.autoload_paths += Dir["#{config.root}/lib", "#{config.root}/lib/**/", "#{config.root}/app/concerns"]
    ...
    config.assets.precompile += %w{visualizations.css import_console/import_console.css import_console/import_console.js}
